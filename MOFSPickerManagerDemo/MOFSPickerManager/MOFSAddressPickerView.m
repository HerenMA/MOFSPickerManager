...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary<NSString *,NSString *> *)attributeDict {
    if ([elementName isEqualToString:@"province"]) {
        ...
        model.index = [NSString stringWithFormat:@"%zd", self.dataArr.count];
        [self.dataArr addObject:model];
    } else if ([elementName isEqualToString:@"city"]) {
        CityModel *model = [[CityModel alloc] initWithDictionary:attributeDict];
        model.index = [NSString stringWithFormat:@"%zd", self.dataArr.lastObject.list.count];
        ...
        model.index = [NSString stringWithFormat:@"%zd", self.dataArr.lastObject.list.lastObject.list.count];
