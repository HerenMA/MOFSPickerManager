...
- (void)showPickerViewWithDataArray:(NSArray *)array tag:(NSInteger)tag title:(NSString *)title cancelTitle:(NSString *)cancelTitle commitTitle:(NSString *)commitTitle commitBlock:(PickerViewCommitBlock)commitBlock cancelBlock:(PickerViewCancelBlock)cancelBlock {
    ...
    [self showPickerViewWithDataArray:array tag:tag defaultIndex:0 title:title cancelTitle:cancelTitle commitTitle:commitTitle commitBlock:commitBlock cancelBlock:cancelBlock];
}

- (void)showPickerViewWithDataArray:(NSArray *)array tag:(NSInteger)tag defaultIndex:(NSUInteger)defaultIndex title:(NSString *)title cancelTitle:(NSString *)cancelTitle commitTitle:(NSString *)commitTitle commitBlock:(PickerViewCommitBlock)commitBlock cancelBlock:(PickerViewCancelBlock)cancelBlock {
    ...
    [self.pickView showMOFSPickerViewWithDataArray:array defaultIndex:defaultIndex commitBlock:^(NSString *string) {
        if (commitBlock) {
            commitBlock(string);
        }
    } cancelBlock:^{
